...
export class GuildRepository extends BaseRepository<DbGuildObject> {
    ...
    async updateGuildInfo(guildId: string, guildName: string, ownerId: string): Promise<DbGuildObject> {
    ...
    async createDefaultGuild(guildId: string, guildName: string, ownerId: string, everyoneRoleId: string): Promise<DbGuildObject> {
